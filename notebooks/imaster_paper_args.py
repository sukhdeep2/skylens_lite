...
wig_home = '/hildafs/projects/phy200017p/andypark/Skylens_public/temp/'
wigner_files = {}
wigner_files[0] = wig_home + "wig3j_l5000_w5000_0_reorder.zarr"
wigner_files[2] = wig_home + "wig3j_l2200_w4400_2_reorder.zarr"
...
bi = (
    0,
    0,
)  # tracer bin indices for cross correlations. always zero because we only use 1 tomographic bin.
