...
class Skylens:
    def __init__(
        ...
        self.Win0 = window_utils(
            ...
            z_bins=self.tracer_utils.z_win,
            window_lmax=self.window_lmax,
            Win=self.Win,
            WT=self.WT,
            do_xi=self.do_xi,
            do_pseudo_cl=self.do_pseudo_cl,
            wigner_step=self.wigner_step,
            skylens_class0=self.skylens0,
            skylens_class_b=self.skylens_b,
            skylens_b_xi=self.skylens_b_xi,
            xi_bin_utils=self.xi_bin_utils,
            store_win=self.store_win,
            wigner_files=self.wigner_files,
            bin_window=self.use_binned_l,
            bin_theta_window=self.use_binned_theta,
